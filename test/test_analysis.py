...
def generateNormativeMeasurement():
...
def outputVisualBasicCodeForNormativeMeasurements(measurements):
...
class TestReferenceValueCalculation(object):
    ...
    def generateNormativeMeasurements(self, numMeasurements):
        for i in xrange(numMeasurements - len(self.normativeMeasurements)):
